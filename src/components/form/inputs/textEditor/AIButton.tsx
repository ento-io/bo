...
const AIButton = ({ isWriting, ...props }: Props) => {
  return (
    <div css={classes.advancedFeaturesButtonContainer} className="flexCenter positionRelative">
      {/* button */}
      ...
      {!props.disabled && (
        <div
          css={[classes.badge, isWriting ? classes.isWritingBadge : classes.defaultBadge]}
          className="positionAbsolute">
          <Typography css={classes.badgeText}>{isWriting ? 'Writing...' : 'AI'}</Typography>
        </div>
      )}
    </div>
  );
